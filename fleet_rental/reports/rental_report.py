...
class FleetRentalReport(models.Model):
    ...
    car_brand = fields.Char(string="Merk Mobil")
    car_color = fields.Char(string="Warna Mobil")
    cost = fields.Float(string="Biaya Sewa")
    rent_start_date = fields.Date(string="Tanggal Mulai Sewa")
    rent_end_date = fields.Date(string="Tanggal Sewa Berakhir")
    state = fields.Selection([('draft', 'Draft'), ('running', 'Running'), ('cancel', 'Cancel'),
                              ('checking', 'Checking'), ('done', 'Done')], string="Status")
    ...
    tools_missing_cost = fields.Float(string="biaya alat hilang")
    damage_cost = fields.Float(string="Biaya kerusakan")
    damage_cost_sub = fields.Float(string="Biaya kerusakan")
